...
import { getOccupiedHousingController } from "../../../socities.controller";
...
export const GET = async (
  ...
  socitiesLogger.info("GET /api/socities/[id]/housing/get-occupied-housing");
  ...
  const { status, ...responseData }: Response<HousingOptions[]> =
    await getOccupiedHousingController(params.id);
