import { deleteHousingPenaltyController } from "@/app/api/socities/socities.controller";
...
export const PATCH = async (
  ...
  socitiesLogger.info(
    "PATCH api/socities/[id]/housing/[housingId]/penalty/[penaltyId]/deleted"
  );
  ...
  const { status, ...responseData }: Response<void> =
    await deleteHousingPenaltyController(
      request,
      params.id,
      params.housingId,
      params.penaltyId
