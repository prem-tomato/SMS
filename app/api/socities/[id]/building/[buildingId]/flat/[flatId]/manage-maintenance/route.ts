import { getManageMaintenanceController } from "@/app/api/socities/socities.controller";
import socitiesLogger from "@/app/api/socities/socities.logger";
import { MaintenanceView } from "@/app/api/socities/socities.types";
...
export const GET = async (
  ...
  socitiesLogger.info(
    "GET api/socities/[id]/building/[buildingId]/flat/[flatId]/manage-maintenance"
  );
