...
export const SocietyBreakdownTable = ({
  ...
  const t = useTranslations("SocietyBreakdownTable");
      ...
      <table className="w-full text-left">
        <thead>
          <tr className="bg-gray-50 border-b">
            <th className="p-4 text-gray-700 font-semibold">{t("society")}</th>
            <th className="p-4 text-gray-700 font-semibold">{t("buildings")}</th>
            <th className="p-4 text-gray-700 font-semibold">{t("flats")}</th>
            <th className="p-4 text-gray-700 font-semibold">{t("members")}</th>
          </tr>
        </thead>
        <tbody>
          {societies.length ? (
